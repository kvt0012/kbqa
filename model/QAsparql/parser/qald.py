...
class Qald:
    ...
    qald_8 = "./data/QALD/qald-8-train-multilingual.json"
    qald_9 = "./data/QALD/qald-9-train-multilingual.json"

    qaldtest_7 = "./data/QALD/qald-7-test-multilingual.json"
    qaldtest_8 = "./data/QALD/qald-8-test-multilingual.json"
    qaldtest_9 = "./data/QALD/qald-9-test-multilingual.json"
